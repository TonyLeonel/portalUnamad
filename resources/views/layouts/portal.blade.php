...
<body>
   ...
   <div id="main">
      ...
      <header class="main-header">
         ...
         <!--  logo  -->
         <div class="logo-holder"><a href="{{ url('/') }}" title="Inicio"><img
                  src="{{ asset('img/logo_horizontal_max2.png') }}" alt="Logo horizontal"></a></div>
         ...
         <div class="nav-element">
            <a href="https://www.transparencia.gob.pe/enlaces/pte_transparencia_enlaces.aspx?id_entidad=13136#.YvEV03ZByUk"
               target="_blank" class="d-none d-md-block" title="Portal Transparencia UNAMAD">
               {{-- <img src="{{ asset('img/transp.png') }}" style="height: 40px;" alt="Logo Transparencia"> --}}
               <img src="{{ asset('img/images/acceso_info_publica.png') }}" style="height: 40px;"
                  alt="Logo Transparencia">
            </a>
            <a href="https://www.produce.gob.pe/index.php/formularios-de-atencion-al-ciudadano/solicitud-de-acceso-a-la-informacion-publica"
               target="_blank" class="d-block d-md-none" title="Portal Transparencia UNAMAD">
               <img src="{{ asset('img/transp_min.jpg') }}" style="height: 30px;" alt="Logo Transparencia">
            </a>
         ...
         <div class="nav-holder main-menu">
            ...
            <nav>
               ...
               <ul class="no-list-style">
                  @foreach ($menus as $menu)
                     @if ($menu->tipo == 1 && $menu->estado == 1)
                        <li class="nav-principal">
                           {{-- inicio --}}
                           <a href="{{ $menu->fuente == 0 ? url('' . $menu->flag . '') : $menu->flag }}"
                              {{ $menu->fuente == 1 ? 'target="_back"' : '' }}
                              class="{{ request()->is($menu->flag) ? 'act-link' : '' }}">{{ $menu->nombre }}</a>
                        ...
                        @if ($menu->estado == 1)
                           <li>
                              @if (count($menu->categorias) > 0)
                                 <a href="#"
                                    class="{{ request()->is($menu->flag . '*') ? 'act-link' : '' }}">{{ $menu->nombre }}<i
                                       ...
                                       @if ($categoria->pagina_categorias_id == null)
                                          @if ($categoria->tipo == 1)
                                             @if ($categoria->fuente == 1)
                                                <a href="{{ $categoria->tipo == 1 ? $categoria->flag : '' }}"
                                                   target="_back"><i class="far fa-globe"></i>
                                                   {{ $categoria->nombre }}</a>
                                             @else
                                                <a href="{{ $categoria->tipo == 1 ? url('' . $categoria->flag . '/unamad') : '' }}"
                                                   class="{{ request()->is($categoria->flag) ? 'act-link' : '' }}"><i
                                                      class="far fa-globe"></i>
                                                   {{ $categoria->nombre }}</a>
                                             @endif
                                          @else
                                             <li>
                                                <a href="#">{{ '>' . $categoria->nombre }} <i
                                                      class="fa fa-caret-down"></i></a>
                                                <!--third  level  -->
                                                <ul>
                                                   @foreach ($categoria->categorias as $items)
                                                      @if ($items->estado == 1)
                                                         <li><a href="{{ url($items->flag . '/unamad') }}"><i
                                                                  class="far fa-globe"></i>
                                                               {{ $items->nombre }}</a></li>
                                                      @endif
                                                   @endforeach
                     ...
                     @if ($menu->posicion == 3)
                        <li class="nav-principal">
                           <a href="#" class="{{ request()->is('facultades*') ? 'act-link' : '' }}">VRA<i
                                 class="fa fa-caret-down"></i></a>
                           <!--second level -->
                           <ul>
                              <li>
                                 <a href="#"><i class="fas fa-stream"></i> Facultades <i
                                       class="fa fa-caret-down"></i></a>
                                       ...
                                       <li>
                                          ...
                                          <ul>
                                             @foreach ($facultad->carreras as $carrera)
                                                <li>
                                                   <a
                                                      href="{{ url('facultades/' . $facultad->flag . '/' . $carrera->abreviatura) }}"><i
                                                         class="far fa-globe"></i>
                                                      {{ $carrera->nombre }}</a>
                                                </li>
                                             @endforeach
                              ...
                              <li>
                                 <a href="#"><i class="far fa-globe"></i> Dirección de Biblioteca
                                    Central</a>
                              </li>
                              <li>
                                 <a href="#"><i class="far fa-globe"></i> Dirección de Proyección
                                    Social y Extensión Cultural</a>
                              </li>
                              <li>
                                 <a href="#"><i class="far fa-globe"></i> Dirección de Bienestar
                                    Universitario</a>
                              </li>
                              <li>
                                 <a href="#"><i class="far fa-globe"></i> Dirección de Asuntos
                                    Académicos</a>
                              </li>
                  ...
                  <li class="nav-principal">
                     <a href="#"
                        class="{{ request()->is('transparencia*') ? 'act-link' : '' }}">TRANSPARENCIA<i
                           class="fa fa-caret-down"></i></a>
                     <!--second level -->
                     <ul>
                        <li><a href="{{ url('transparencia/indicador-55') }}"><i class="far fa-globe"></i>
                              Indicador 55</a></li>
                        <li><a href="{{ url('transparencia/licenciamiento') }}" class="lh-sm"><i
                                 class="far fa-globe"></i>
                              Licenciamiento Institucional</a></li>
                        <li>
                           <a href="#" class="lh-sm"><i class="fas fa-stream"></i> Acceso a
                              Información Pública <i class="fa fa-caret-down"></i></a>
                           <!--third  level  -->
                           <ul>
                              <li><a href="https://facilita.gob.pe/t/3371" target="_blank"><i
                                       class="far fa-globe"></i>
                                    Formulario Virtual</a></li>
                              <li><a href="https://drive.google.com/file/d/1tStD8HiMChMZO8QmnepBPU3evR920xGz/view?usp=sharing"
                                    target="_blank"><i class="far fa-globe"></i> Descargar
                                    Formato</a>
                              </li>
                           </ul>
                           <!--third  level end-->
                        </li>
                        <li><a href="{{ url('documentos') }}" class="lh-sm"><i class="far fa-globe"></i>
                              Documentos Normativos y de Gestión</a></li>
                     </ul>
                     <!--second level end-->
                  </li>
      ...
      <div id="wrapper">
         ...
         <footer class="gray-section main-footer fl-wrap image_complete">
            {{-- <footer class="main-footer fl-wrap image_complete"
                     style="background-image: url({{ asset('img/tejido.png')}});"> --}}
