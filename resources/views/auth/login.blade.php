...
<div class="container-tight py-4">
    ...
    <form class="card card-md" method="POST" action="{{ url('login') }}" onsubmit="return login(event);">
        ...
        <div id="form_login" class="card-body">
            <h3 class="text-center mb-2">Panel Administrador</h3>
            <div class="pb-3">
                @if ($errors->any())
    ...
    <div class="text-center text-muted mt-3">
        Si tienes problemas para ingresar, comunicate a <a href="mailto:oti@unamad.edu.pe" tabindex="-1" >oti@unamad.edu.pe</a>
    </div>
</div>
@endsection
