...
@section('titulo', 'Centro de Informática')
...
<section class="relative-padding hidden-section single-par2  " data-scrollax-parent="true">
    ...
    <div class="container">
        <div class="section-title center-align big-title">
            <h2><span>Centro de Informática</span></h2>
...
<div class="breadcrumbs fw-breadcrumbs sp-brd fl-wrap image_bar">
    <div class="container">
        ...
        <div class="share-holder hid-share">
            <a href="javascript:void(0);" onclick="compartir(this);" data-link="{{ url('programas/informatica') }}" class="share-btn">
