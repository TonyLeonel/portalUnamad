...
@section('titulo', $categoria->nombre.' - '.$pagina->titulo)
...
<section class="relative-padding hidden-section single-par2  " data-scrollax-parent="true">
    ...
    <div class="container">
        <div class="section-title center-align big-title">
            <h2><span>{{$categoria->nombre}}</span></h2>
            <h4></h4>
        </div>
...
<div class="breadcrumbs fw-breadcrumbs sp-brd fl-wrap top-smpar">
    <div class="container">
        <div class="breadcrumbs-list">
            <a href="{{ url($categoria->flag) }}">{{$categoria->nombre}}</a>            
...
<section class="relative-padding gray-bg small-padding fl-wrap">
    <div class="container">
        <div class="row">
            <div class="col-md-4">  
                @include('secciones.paginas.menu_paginas')                              
            </div>
            <div class="col-md-8">
