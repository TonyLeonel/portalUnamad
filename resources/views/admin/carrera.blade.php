...
<script src="{{ asset('js/admin/carreras.js') }}" type="text/javascript"></script>
@endsection
    ...
    <div class="page-header d-print-none">
        <div class="row align-items-center">
            ...
            <div class="col-auto ms-auto">
                <div class="btn-list">
                    <a href="{{url('admin/carreras/nuevo')}}" class="btn btn-primary d-sm-inline-block" >
    ...
    <div class="container-xl">
        <div class="row row-cards">
            <div class="col-12">
                <div class="card">
                    <div id="t_principal">
                        <table id="t_carreras" class="table card-table table-vcenter text-nowrap datatable" width="100%">
                            <thead>
                                <tr>   
                                    <th>NOMBRE</th>                                 
                                    <th>FACULTAD</th>
