...
@section('titulo', 'Administración de publicaciones')
...
<script src="{{ asset('js/admin/publicaciones.js') }}" type="text/javascript"></script>
@endsection
    ...
    <div class="page-header d-print-none">
        <div class="row align-items-center">
            ...
            <div class="col-auto ms-auto">
                <div class="btn-list">
                    <a href="{{ url('admin/publicaciones/nuevo') }}" class="btn btn-primary d-sm-inline-block" >
        ...
        <div class="row row-cards">
            <div class="col-12">
                <div class="card">
                    ...
                    <div id="t_principal">
                        <table id="t_publicaciones" class="table card-table table-vcenter text-nowrap datatable" width="100%">
                            <thead>
                                <tr>    
                                    <th>CATEGORÍA</th>                              
                                    <th>TÍTULO</th>                                    
