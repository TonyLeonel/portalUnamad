...
<script src="{{ asset('js/admin/pagina_categorias.js') }}" type="text/javascript"></script>
@endsection
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div id="form_editar" class="modal-body">  
                <div class="row">
                    <div class="col-6 form-group form-required">
                        <label class="form-label">Menu</label>
                        <select type="text" class="form-select" placeholder="Select a date" id="menu_id" onchange="lista_categorias(0)">                       
                    ...
                    <div class="col-6 form-group form-required mb-3">
                        ...
                        <select type="text" class="form-select" placeholder="Select a date" id="tipo" onchange="tipo_menu(this,0)">                       
                    ...
                    <div class="row oculto" id="div_menu">
                        <div class="col-6 form-group form-required mb-3" >
                            ...
                            <select type="text" class="form-select" placeholder="Select a date" id="categoria_id">                       
                            </select>
                        </div> 
                        <div class="col-6 form-group form-required mb-3">
                    ...
                    <div class="col-6 form-group mb-3 oculto" id=div_telefono>
                        <label class="form-label">Teléfono</label>
                        <input id="telefono" type="text" class="form-control" placeholder="">
                    </div>
                    <div id="datos_pagina" class="row oculto">
                    ...
                    <div class="form-group oculto" id="div_flag">
