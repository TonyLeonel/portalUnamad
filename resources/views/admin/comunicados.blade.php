...
@section('titulo', 'Administración de comunicados')
...
<script src="{{ asset('js/admin/comunicados.js') }}" type="text/javascript"></script>
@endsection
    ...
    <div class="page-header d-print-none">
        <div class="row align-items-center">
            ...
            <div class="col-auto ms-auto">
                <div class="btn-list">
                    <a href="{{ url('admin/comunicados/nuevo') }}" class="btn btn-primary d-sm-inline-block" >
