...
$( document ).ready(function() {
    ...
    tabla = $("#t_docentes").DataTable({
        "processing": true,
        "serverSide": true,
        "pageLength": 50,
        "order": [],
        "ajax": {
            "url":  default_server+"/json/docentes",
            "type": "GET",
            "data": function ( d ) { },
            ...
            { 
                ...
                "searchable": false, "orderable": false, className: "w-1",
                    ...
                    var res = '<div class="btn-list flex-nowrap">'+
                                '<a href="'+default_server+'/admin/docentes/modificar/'+full.id+'" class="btn btn-white btn-icon" title="MODIFICAR">'+
...
function eliminar(iditem) {
    if(confirm('Esta seguro que desea eliminar?'))
    {
        ...
        $.ajax({
            type: "DELETE",
            url: default_server+"/json/docente/"+iditem,        
