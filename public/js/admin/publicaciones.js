...
$( document ).ready(function() {
    ...
    tabla = $("#t_publicaciones").DataTable({
        "processing": true,
        "serverSide": true,
        "pageLength": 50,
        "order": [],
        "ajax": {
            "url":  default_server+"/json/publicaciones",
            "type": "GET",
            "data": function ( d ) {
            ...
            { 
                ...
                "searchable": false, "orderable": false, className: "w-1",
                    ...
                    var res = '<div class="btn-list flex-nowrap">'+
                                '<a class="btn btn-white btn-icon" href="'+default_server+'/admin/publicaciones/modificar/'+full.id+'" title="MODIFICAR">'+
...
function eliminar(iditem) {
    if(confirm('Esta seguro que desea eliminar?'))
    {
        $.ajax({
            type: "DELETE",
            url: default_server+"/json/publicaciones/"+iditem,        
